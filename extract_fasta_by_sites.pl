...
#	[1] a GTF file containing the CDS products to extract. ONLY WORD CHARACTER NAMES
...
#				"length $extracted_length_total";
			...
			#print OUTPUT_FILE "$new_header\_$product\n";
...
# 			my $new_header = $headers_arr[$seq_index];  # this was last used
			my $new_header = $headers_arr[$seq_index] . "_$product";  # NEW to include ORF name in header
